...
--
-- Host: localhost
-- Generation Time: Dec 06, 2019 at 01:41 AM
...
INSERT INTO `articles` (`id`, `ref_id`, `category_id`, `title`, `slug`, `thumbnail`, `description`, `content`, `keyword`, `status`, `priority`, `language`, `created_at`, `created_user_id`, `updated_at`, `updated_user_id`, `deleted_at`, `deleted_user_id`) VALUES
