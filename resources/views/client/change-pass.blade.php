...
<html xmlns="http://www.w3.org/1999/xhtml" lang="vi">
   <head>
      ...
      <link rel='canonical' href='https://mizuiku-emyeunuocsach.vn/doi-mat-khau.htm' />
      ...
      <meta property="og:url" content="https://mizuiku-emyeunuocsach.vn/doi-mat-khau.htm" />
      ...
      <script type="text/javascript"> jwplayer.key = "mGDOS7fVOAOlydlRCHC0GR7sLKgUNTAM1BH6/Q=="; </script>  
      ...
      <form name="form1" method="post" action="/doi-mat-khau.htm" id="form1" enctype="multipart/form-data">
         ...
         <div id="header">
            <div class="wrp">
               <div class="buton">
                  <div class='hocngay'>
                     <a href='https://mizuiku-emyeunuocsach.vn/e-learning.htm'  class='btnhocngay' title='Learn now'>Learn now</a>
                  ...
                  <div class="regis">
                     <div class="regis1">
                        <a href='https://mizuiku-emyeunuocsach.vn/thanh-vien.htm' title='Helen' class='btndk ac fs12'>Xin chào, Helen</a>
                        <span class='border'></span>
                        <ul class='subloginx sublogin'>
                           <li><a href='https://mizuiku-emyeunuocsach.vn/quan-ly-tai-khoan.htm' title='Thông tin tài khoản'>Thông tin tài khoản</a></li>
                           <li><a href='https://mizuiku-emyeunuocsach.vn/doi-mat-khau.htm' title='Đổi mật khẩu'>Đổi mật khẩu</a></li>
                           <li><a href='https://mizuiku-emyeunuocsach.vn/quan-ly-khoa-hoc.htm' title='Khóa học của tôi'>Khóa học của tôi</a></li>
                           <li><a href='javascript:;' title='' class='logout_open'>Thoát</a></li>
                        </ul>
                     </div>
                  </div>
         ...
         <div id="menu">
            <div class="wrp">
               ...
               <ul id='CommonMenuMain' class='main'>
                  ...
                  <li data='2' class='litop hassub'>
                     <a href='https://mizuiku-emyeunuocsach.vn/gioi-thieu.htm'  title='About us'>About us</a>
                     <ul>
                        <li>
                  ...
                  <li data='3' class='litop hassub'>
                     <a href='https://mizuiku-emyeunuocsach.vn/tin-tuc.htm'  title='News'>News</a>
                     <ul>
                        <li>
                  ...
                  <li data='4' class='litop hassub'>
                     <a href='https://mizuiku-emyeunuocsach.vn/thu-vien.htm'  title='Gallery'>Gallery</a>
                     <ul>
                        <li>
                  ...
                  <li data='5' class='litop hassub'>
                     <a href='https://mizuiku-emyeunuocsach.vn/lich-trinh.htm'  title='Program timeline'>Program timeline</a>
                     <ul>
                        <li>
                  ...
                  <li data='6' class='litop hassub'>
                     <a href='https://mizuiku-emyeunuocsach.vn/khoa-hoc.htm'  title='E-learning'>E-learning</a>
                     <ul>
                        <li>
         ...
         <div id="pageroad">
            <div class="wrp">
               <ul>
                  ...
                  <li><a href='https://mizuiku-emyeunuocsach.vn/thanh-vien.htm' title='Thành viên'>Thành viên</a></li>
               </ul>
               <div class="cb"></div>
            </div>
         </div>
            ...
            <div class="wrp">
               <div class="left">
                  ...
                  <div>
                     ...
                     (Granted by Department of Information and Communications of Ho Chi Minh city, 23Mar2018)</span><br />
                     Suntory PepsiCo Vietnam Beverage
                  </div>
                  <div>
                     Address: 5th Floor, Sheraton Hotel, 88 Dong Khoi Street, District 1, Ho Chi Minh City, Vietnam.
                  </div>
                  <div>
                     Tel: (84 28) 3 821 9437&nbsp;
                  </div>
                  <div>
                     Website: www.mizuiku-emyeunuocsach.vn<br />
                     &nbsp;
                  </div>
               ...
               <div class='right'>
                  <div>
                     <div class='lienket'>
                        <span class='c005286 fOfficinaSanITCMedium'>Website Link </span>
                  ...
                  <div class='solieu'>
                     <span class='online'>Online: 7</span>
         ...
         <script type="text/javascript">
            ...
            function registerMember() {
                ...
                var account = "", email = "", matkhau = "", hovaten = "", gioitinh = "", sodienthoai = "", chucvu = "", thanhpho = "", quanhuyen = "", noicongtac = "";
            ...
            function loginMember() {
                ...
                jQuery.ajax({
                    ...
                    success: function (res) {
                        loading(false);
                        if (res[0] === "Success") {
                            window.location.href = 'https://mizuiku-emyeunuocsach.vn/doi-mat-khau.htm';
                        }
         ...
         <style>
            #slide_background, #success_background, #loginForm_background, #ForgotForm_background {
