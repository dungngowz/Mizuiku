...
<head>
    ...
    <link rel='canonical' href='https://mizuiku-emyeunuocsach.vn/thong-ke.htm' />
    <meta name="keywords" content="mizuiku - em yêu nước sạch" />
    <meta name="description" content="mizuiku - em yêu nước sạch" />
    <meta property="og:title" content="Timeline" />
    <meta property="og:type" content="article" />
    <meta property="og:url" content="https://mizuiku-emyeunuocsach.vn/thong-ke.htm" />
...
<body>
    <form name="form1" method="post" action="/thong-ke.htm" id="form1">
        ...
        <div>
            ...
            <input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="" />
        </div>
        ...
        <div id="pageroad">
            <div class="wrp">
                <ul>
                    ...
                    <li><a href='https://mizuiku-emyeunuocsach.vn/khoa-hoc.htm' title='Course'>Course</a></li>
                </ul>
                <div class="cb"></div>
            </div>
        </div>
        ...
        <div id="Analytisc">
            ...
            <div class='tit2'>Kết quả thống kê: 296 học viên, 3 học viên đã hoàn thành</div>
            <div class="groupItems">
                <div class="item head">
                    <div class="col col1">STT</div>
                    <div class="col col2">Tỉnh/Thành phố</div>
                    <div class="col col3">Quận/Huyện/Thị xã</div>
                    <div class="col col4">Trường/Nơi công tác</div>
                    <div class="col col5">Số lượng học viên</div>
                    <div class="col col6">SL học viên đã hoàn thành</div>
                </div>
        ...
        <a href="javascript:void(0)" class="loginForm2_open"></a>

        <style>
            #Analytisc .Filter .item input {
                width: 100%;
                padding: 0 10px;
            ...
            #Analytisc .groupItems .item .col4 {
                width: 285px;
                min-width: 285px;
                min-height: 10px;
            }
        ...
        <script>
            function checkRoles() {
                $(document).ready(function() {
                    $(".loginForm2_open").click();

                });
            }

            function KhongDuocPhepTruyCap() {
                $(document).ready(function() {
                    $("#success .tac").html("Bạn không được phép xem thống kê, vui lòng liên hệ với quản trị website.");
                    $(".success_open").click();
                });
            }

            function CheckDrop() {
                if ($("#DisplayLoadControl_ctl00_ctl00_ddlCity option:selected").val() === "0") {
                    alert("Vui lòng chọn Tỉnh/Thành phố cần thống kê");
                    return false;
                }
                if ($("#DisplayLoadControl_ctl00_ctl00_ddlDistrict option:selected").val() === "0") {
                    alert("Vui lòng chọn Quận/Huyện/Thị xã cần thống kê");
                    return false;
                }
            }
        </script>
	...
	(Granted by Department of Information and Communications of Ho Chi Minh city, 23Mar2018)</span>
                ...
                <div class='right'>
                    ...
                    <div class='solieu'>
                        <span class='online'>Online: 11</span>
            ...
            function loginMember() {
                ...
                jQuery.ajax({
                    ...
                    success: function(res) {
                        loading(false);
                        if (res[0] === "Success") {
                            window.location.href = 'https://mizuiku-emyeunuocsach.vn/thong-ke.htm';
