         ...
         <div id="member">
            ...
            <div class="left">
               <div class="khungAnh">
                  ...
                  <img alt="helen.hoa1103@gmail.com" class="Avatar" src="https://mizuiku-emyeunuocsach.vn/pic/icon/no_image.gif" />
                  </a>
            ...
            <div class="right">
               ...
               <ul>
               <li class="active"><a href="{{ route('showManageAccount') }}" title="Thông tin tài khoản">Thông tin tài khoản</a></li>
                  <li class="normal"><a href="{{ route('showChangePassword') }}" title="">Đổi mật khẩu</a></li>
                  <li class="normal"><a href="{{ route('showMyCourse') }}" title="Khoá học của tôi">Khoá học của tôi</a></li>
