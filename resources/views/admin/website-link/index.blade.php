        ...
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                ...
                <div class="ml-auto text-right">
                    <button type="button" id="btn-remove-all" data-url="{{url('admin/website-link/delete-multiple')}}" class="btn btn-danger">{{trans('admin.delete_selected_item')}}</button>

                    <a href="{{url('admin/website-link/create')}}">
