...
class User extends Authenticatable implements MustVerifyEmail
{
     ...
     */
    protected $fillable = [
        'name', 'email', 'username', 'password', 'phone', 'remember_token', 'sex', 'career', 'province_id', 'district_id', 'work_place', 'avatar', 'learning_process', 'status', 'actived', 'birthday', 'receive_emails'
    ];
