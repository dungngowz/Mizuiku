 ...
 */
class Partner extends SoftModelBase
{
    use SortByScope;
     ...
     * @var array
     */
    protected $fillable = ['ref_id', 'type', 'title', 'priority', 'language', 'url', 'thumbnail', 'status', 'created_at', 'created_user_id', 'updated_at', 'updated_user_id', 'deleted_at', 'deleted_user_id'];
